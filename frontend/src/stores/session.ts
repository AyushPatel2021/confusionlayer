...
export const useSessionStore = defineStore("session", {
  ...
  actions: {
    ...
    async loadTimetable() { this.loading = "timetable"; this.error = ""; try { this.timetable = await api<TimetableEntry[]>("/api/timetable"); } catch (error) { this.error = messageFromError(error); } finally { this.loading = ""; } },
