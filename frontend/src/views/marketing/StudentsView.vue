...
const chat = [
  { who: "you", text: "How do I balance H₂ + O₂ into H₂O?", type: "" },
...
<template>
  <div class="overflow-hidden">
    <section class="mx-auto grid max-w-content items-center gap-12 px-6 pb-14 pt-16 lg:grid-cols-[1fr_1fr] lg:pt-24">
      <div>
        <p v-reveal class="s-eyebrow">For individual learners</p>
        ...
        <div v-reveal class="mt-8">
          <RouterLink to="/signup?segment=individual" class="nudge-host">
            <SButton variant="primary">Start learning free</SButton>
          </RouterLink>
        </div>
      </div>
